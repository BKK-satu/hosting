...
class MitraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/ad/mt/list')->with('success', 'Mitra baru berhasil ditambahkan');
    }
    ...
    {
        // $decrypt = decrypt($id);
        $mitra = $this->mitraModel->where('id_mitra' ,$id)->first();
        $kantor = $this->kantorModel->where('mitra_id', $id);
        // dd($kantor);
    ...
    {
        $id_user = $this->mitraModel->where('id_mitra', $id)->first();
        $id_user = $id_user->user_id;

        $mitra = Mitra::findOrFail($id)->delete();
        $kantor = Kantor::findOrFail($id)->delete();
        $user = User::findOrFail($id_user)->delete();
        // $loker = LowonganKerja::findOrFail($id)->delete();

        return redirect('/ad/mt/list');
    }
}
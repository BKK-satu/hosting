...
class PagesController extends Controller
{
    ...
    public function alumniShow($id)
    {
         ...
         */
        $data_alumni = Alumni::where('id_alumni', $id)->get();
         ...
         */
        $data_pekerjaan = $this->pekerjaanModel->where('alumni_id', $id)->get();
         ...
         */
        $data_pendidikan = $this->pendidikanModel->where('alumni_id', $id)->get();

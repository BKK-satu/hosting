                        ...
                        <div class="content mb-2">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{$id++}}</th>
                                        <td><a href="{{route('admin.mitra.detail', $mitra->id_mitra)}}" class="text-link-black text-decoration-none">{{$mitra->jenis}}. {{$mitra->nama}}</a></td>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col">
                                                    <a href="{{route('admin.mitra.edit', $mitra->id_mitra)}}" data-toggle="tooltip" data-placement="bottom" title="Ubah Data Mitra"><i class="bx bx-edit text-warning tols"></i></a>
                                                </div>
                                                <div class="col">
                                                    <button class="rounded-15" onclick="deleteData('{{$mitra->id_mitra}}')" type="submit" data-toggle="tooltip" data-placement="bottom" title="Hapus Data Mitra"><i class="bx bx-trash-alt text-danger"></i></button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>

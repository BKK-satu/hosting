        ...
        <div class="content-outer-wrapper mx-auto">
            <div class="container py-3 content-wrapper">
                ...
                <div class="title-back">
                    <a href="{{ route('admin.mitra') }}" class="d-flex align-items-center text-decoration-none text-white">
                ...
                <div class="edit-wrapper d-flex">
                    <div class="data me-4 bg-white rounded-15 px-4 py-3">
                        ...
                        <form action="{{route('admin.mitra.store')}}" method="POST" class="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <!-- EDITOR CK EDITOR 5 -->
                                <label for="editor" class="mb-2">Alamat</label>
                                <textarea name="alamat" id="editor">&lt;p&gt;&bnsp&&lt;/p&gt;</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('admin.mitra') }}" class="btn btn-secondary fw-700 rounded-15 me-2">Cancel</a>

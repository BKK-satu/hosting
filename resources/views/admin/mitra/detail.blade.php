                ...
                <div class="detail-outer-wrapper shadow-custom-2 rounded-20 mx-0 mx-md-5 mb-5">
                    <div class="header d-flex align-items-center">
                        ...
                        <div class="img rounded-circle ms-5">
                            <img src="{{asset ('/assets/img/mitra/' . $mitra->foto)}}" alt="logo" width="200px">
                        </div>
                        @else
                        <div class="img rounded-circle ms-5">
                            <img src="{{asset ('/assets/img/imp/default-company.png')}}" alt="logo" width="200px">
                        </div>
                        @endif
                    </div>
                    <!-- ISI DATA-DATANYA -->
                        ...
                        <table class="table table-borderless overflow-scroll">
                            ...
                            <tbody>
                                ...
                                <tr class="row justify-content-between">
                                    ...
                                    <td class="col-5">{!! $mitra->kantor_pusat !!}</td>

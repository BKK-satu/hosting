        ...
        <div class="content-outer-wrapper mx-auto">
            <div class="container py-3 content-wrapper">
                ...
                <div class="title-back">
                    <a href="{{ route('admin.alumni') }}" class="d-flex align-items-center text-decoration-none text-white"><i
                ...
                <div class="edit-wrapper d-flex mb-5">
                    <div class="data me-4 bg-white rounded-15 px-4 py-3">
                        ...
                        <!-- FORM INPUTANNYA -->
                        <form action="{{route('admin.alumni.update', $alumni->id_alumni)}}" method="POST" class="">
                            @csrf
                            <div class="mb-3">

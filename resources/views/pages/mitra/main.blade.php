    ...
    <div class="container">
        ...
        <div class="row justify-content-center g-2 g-lg-4" data-masonry='{"percentPosition": true }'>
            ...
            <div class="col-6 col-lg-3">
                <div class="box">
                    @if ($data->foto === 'default-company.png')
                    <img src="{{asset('/assets/img/imp/default-company.png')}}" alt="mitra" class="rounded img-fluid mitra-img">
                    @else
                    <img src="{{asset('/assets/img/mitra/' . $data->foto)}}" alt="mitra" class="rounded img-fluid mitra-img">
                    @endif
